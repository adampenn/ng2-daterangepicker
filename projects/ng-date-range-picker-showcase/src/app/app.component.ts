...
import { NgDateRangePickerService } from '../../../ng-date-range-picker/src/ng/ng-date-range-picker.service';
...
export class AppComponent {
  ...
  constructor(private daterangepickerOptions: NgDateRangePickerService) {
